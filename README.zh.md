...
<p align="center"><sub>generation: <code>1a5e805</code> (2026-08-29T02:52:48Z) · verify: <a href="https://api.github.com/repos/caty-ai/family-memory-architecture/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
![共享记忆循环的 28 秒终端演示。一个智能体把一项决定记录为不可变的收件箱事件，生成器把收件箱汇总成一页简短的共享页面，所有智能体在会话开始时读取这份通过校验和验证的页面。](assets/readme/demo.gif)
