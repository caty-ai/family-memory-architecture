...
This wraps `python3 scripts/tests/run_tests.py`; the aggregate suite includes the write-guard and injection-lint tests. `make lint` also exists for parity with family CI and is currently a no-op.
