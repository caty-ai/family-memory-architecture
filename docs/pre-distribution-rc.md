...
| #54 mechanism side: stdlib clean-room, failure classes, canonical test discovery | mechanism | OPEN | content-lint v1 merged (PR #107) covers only the lint slice; #133 (stdlib manifest parser + failure classification) OPEN | **OUTSTANDING** |
| #132 gitleaks fixture allowlist + negative machine gate | mechanism | OPEN | draft PR #137 open, unmerged | **OUTSTANDING** |
| #133 stdlib manifest parser + lint failure classification | mechanism | OPEN | none in repo | **OUTSTANDING** |
