...
![เดโมในเทอร์มินัลความยาว 28 วินาทีของวงจรความจำที่ใช้ร่วมกัน เอเจนต์หนึ่งบันทึกการตัดสินใจเป็นเหตุการณ์ที่แก้ไขไม่ได้ในกล่องรับ จากนั้นตัวสร้างรวบรวมกล่องรับให้เป็นหน้าแชร์สั้น ๆ หนึ่งหน้า และเอเจนต์ทุกตัวอ่านหน้าที่ผ่านการตรวจสอบ checksum นั้นเมื่อเริ่มเซสชัน](assets/readme/demo.gif)
...
| OS | ✅ macOS (ผ่านชุดทดสอบเต็ม) ／ ✅ Linux (สคริปต์ฝั่งเซิร์ฟเวอร์ทำงานจริงทุกวัน) ／ ✅ Windows ผ่าน WSL2 (เก็บ vault ไว้บน ext4 ห้ามไว้ใน `/mnt/c` — ดู[คู่มือเริ่มต้น](docs/getting-started.md)) |
...
| โครงสร้างทั้งรีโปและหน้าที่ของสคริปต์ทั้ง 27 ตัว | [docs/repository-map.md](docs/repository-map.md) |
