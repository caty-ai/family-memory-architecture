...
ให้รันภายใต้โฮมไดเรกทอรีของคุณ ในตำแหน่งที่ group ownership ต่างจากปกติ (เช่น `/tmp`) การตรวจสิทธิ์อัตโนมัติจะเอียงไปทางปลอดภัยและหยุดด้วย exit 2 — นั่นคือการตรวจที่ทำงานถูกต้อง ไม่ใช่ความผิดพลาด
